...
class ListMixinGenericView(CreateModelMixin,ListModelMixin, GenericAPIView):
    model = ''
    queryset = model.objects.all()
    serializer_class = ''
...
class DetailMixinGenericView(DestroyModelMixin,UpdateModelMixin,RetrieveModelMixin, GenericAPIView):
        model = ''
        queryset = model.objects.all()
        serializer_class = ''
        lookup_field = 'id'
...
class ListGV(ListGenericView):
    model = ''
    serializer_class = ''

class DetailGV(DetailGenericView):
    model = ''
    serializer_class = ''
